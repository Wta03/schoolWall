...
<template>
    <div>
        <div class="body_first" v-for="(us, index) in dat" :key="index">
            <div class="first_line" style="position:relative;">
                ...
                <div class="button"  @click="but_sx(us, index)">
...
export default {
    ...
    data() {
        return {
            ...
            user_tx: ['http://localhost:3000/public/tx/th0.png', 'http://localhost:3000/public/tx/th1.png', 'http://localhost:3000/public/tx/th2.png', 'http://localhost:3000/public/tx/th3.png', 'http://localhost:3000/public/tx/th4.png'],
            dat: [],
            thing: [],
            form_id: 0,
            pl_all: [],
        ...
        showStu_user_sx(us) {
            axios.get('http://localhost:3000/api/Stu/showStu_user_sx',).then((response) => {
                ...
                for (let a = 0; a < this.user_sxd.length; a++) {
                    if ((this.user_sxd[a].user1 == this.user_name) && (this.user_sxd[a].user2 == us.user_name)){
                        this.$router.push({ name: 'wdxx_sx', params: { user_name: this.user_name, duser: us.user_name } });
                        break;
                    } else if ((this.user_sxd[a].user2 == this.user_name) && (this.user_sxd[a].user1 == us.user_name)){
                        this.$router.push({ name: 'wdxx_sx', params: { user_name: this.user_name, duser: us.user_name } });
                        break;
                    }else{
                        this.lz1(us);
