...
<template>
    <div class="div_at">
        <el-descriptions class="margin-top" title="ta 的信息" :column="3" :size="size" border >
            ...
            <div class="first_line" style="position:relative;">
                ...
                <div class="xg_bd" style="display:none">
                    <div class="div_flex">
                        ...
                        {{ js[us.form_id - 1][2] }}<textarea name="something" id="" cols="30" rows="10"
                            v-model="something"></textarea>
                        <div class="div_radio">
        ...
        showStu1() {
            axios.get('http://localhost:3000/api/Stu/showStu',).then((response) => {
                ...
                for (let a = 0; a < this.dat.length; a++) {
                    if (this.dat[a].user_name == this.duser) {
        ...
        showStu3() {
            axios.get('http://localhost:3000/api/Stu/showStu_grzx',).then((response) => {
                ...
                for (let a = 0; a < this.pas.length; a++) {
                    if (this.pas[a].username == this.$route.params.duser) {
