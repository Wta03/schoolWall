...
.div_flex{
    ...
    .div_flex input[type="text"],.div_flex textarea{
        color: #757575;
        margin: 20px;
        padding: 25px;
        border-radius: 25px;
    ...
    .div_flex input[type="text"]:focus,.div_flex textarea:focus{
    ...
    <div class="div_flex">
        ...
        <div>
            <el-upload class="upload-demo" action="http://localhost:3000/upload" :on-remove="handleRemove"
                ...
                :on-success="uploadSuccess" :data="date">
...
export default {
    ...
    methods: {
        ...
        add() {
            ...
            axios.post('http://localhost:3000/api/Stu/addStu1', {user_name:this.user_name,time:this.getFormatDate(),form1:this.thing,form2:this.something,img_src:this.src,have_name:this.who,form_id:2,tx_imge:this.user1.circleUrl,name:this.user1.name}, {}).then((response) => { console.log(response); });
        },
        ...
        tj() {
            if(this.thing!='物品名' && this.thing!='' && this.something!='物品介绍' && this.something!=''){
                this.open2();
                this.add();
