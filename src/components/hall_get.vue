    ...
    <div>
        <div class="body_first" v-for="(us, index) in dat" :key="index">
            <div class="first_line">
                ...
                <div
                    style="position: relative;left: 50%; color:#ebecf0dd  ;font-size: 30px; font-weight: 100; text-shadow: 1px 1px 1px rgb(71, 71, 71), -1px -1px 1px #fff;">
                    寻物
                </div>
            </div>
            <div class="last_line">
                ...
                <div class="js">
                    <div>
                        丢失物: <span>{{ us.form1 }}</span>
                    </div>
                    <div>
                        丢失物介绍: <span>{{ us.form2 }}</span>
                    </div>
                </div>
            </div>
            <div class="next_line">
...
export default {
    ...
    methods: {
        ...
        showStu1() {
            axios.get('http://localhost:3000/api/Stu/showStu3',).then((response) => {
